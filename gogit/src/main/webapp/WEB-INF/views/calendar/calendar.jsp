...
<html>
  <head>
    ...
    <script>
          ...
          var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventChange: function (e) {
              ...
              $.ajax({
                ...
                success: function (data) {
                	...
                	if(socket){
                		console.log(e)
                		socket.send("${loginUser.memId},"+e.event._def.title+",${loginUser.team},"+e.event._def.publicId+",ucalendar")
                		location.href="main"
                	}
                },
                error: function () {},
            ...
            eventRemove: function (e) {
              ...
              $.ajax({
                ...
                success: function (data) {
					...
					if(socket){
						socket.send("${loginUser.memId},"+e.event._def.title+",${loginUser.team},"+e.event._def.publicId+",dcalendar")
						location.href="main"
                	}
                },
                error: function () {},
            ...
            select: function (e) {
              ...
              $("#addEvent").on("click", function () {
                ...
                if(socket){
               	   socket.send("${loginUser.memId},"+$("#content").val()+",${loginUser.team},"+num+",calendar")
                  }
      ...
      function checkInput() {
        if ($("#content").val().length != 0 && $("#startTime").val().length != 0 && $("#endDate").val().length != 0 && $("#endTime").val().length != 0) {
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-warning" id="addEvent" disabled>
              추가
            </button>
          </div>
        </div>
