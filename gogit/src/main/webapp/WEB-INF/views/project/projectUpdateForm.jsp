             ...
             <div class="row" style="display: flex;">	          	          		
					<div class="pj-wrap" style="display: flex;">
						<div style="width: 100%; background-color: #ffffff;" class="sideleft-div">
							...
							<form action="update.pr" method="post" id="myForm">												
								...
								<div style="display:flex;">
									...
									<div class="right-div">
										...
										<div class="form-group">
											<div>모집 마감일</div>
											<div style="margin-bottom: 10px;">
												<input type="date" class="form-control" id="endDate" name="deadLine" value="${p.deadLine }">
											</div>
										</div>
							...
							<div class="bottom-div" style="padding: 10px;">
								<div style="display: flex; margin-top: 50px;">
									...
									<div style="margin-top: 5px;"><p>수정할 프로젝트 내용을 작성해 주세요.</p></div>
								</div>
								<hr>
								...
								<div class="form-group" style="width: 1000px;">
									<div>제목</div>
									<div>
										<input type="text" class="form-control" id="content" name="proTitle" value="${p.proTitle }">
									</div>
								</div>
								<br>
								...
								<script>
									...
									function submitForm() {
										...
										location.href="update.pr";
									}
								</script>


								<div style="float: right;">
									<button type="submit" class="btn btn-primary" style="background-color: rgb(2 56 75);" onclick="submitForm()">수정하기</button><a class="btn btn-primary" style="background-color: rgb(4, 91, 122);" onclick="history.back();">이전으로</a>
								</div>							
							</div>
						</form>	
						</div>
