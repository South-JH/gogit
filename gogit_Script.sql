...
-- 멤버 테이블 샘플데이터 5개
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, MEM_INTRO, CREATE_DATE, STATUS, STACK_NAME, TEAM, TEAM_STATUS,GIT_NICK) VALUES (SEQ_MNO.NEXTVAL, '0000', '00000', '자기소개1', DEFAULT, DEFAULT, 'JAVA, AWS', 1, 'Y','호빵천사친구');
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, MEM_INTRO, CREATE_DATE, STATUS, STACK_NAME, TEAM, TEAM_STATUS,GIT_NICK) VALUES (SEQ_MNO.NEXTVAL, '11111', '21451', '자기소개1', DEFAULT, DEFAULT, 'JAVA, AWS', 1, 'Y','호빵천사');
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, MEM_INTRO, CREATE_DATE, STATUS, STACK_NAME, TEAM, TEAM_STATUS,GIT_NICK) VALUES (SEQ_MNO.NEXTVAL, '22222', '46747', '자기소개2', DEFAULT, DEFAULT, 'JAVA, AWS', 1, 'Y','찐빵천사');
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, MEM_INTRO, CREATE_DATE, STATUS, STACK_NAME, TEAM, TEAM_STATUS,GIT_NICK) VALUES (SEQ_MNO.NEXTVAL, '33333', '21125', '자기소개3', DEFAULT, DEFAULT, 'JAVA, AWS', 1, 'Y','피자빵천사');
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, MEM_INTRO, CREATE_DATE, STATUS, STACK_NAME, TEAM, TEAM_STATUS,GIT_NICK) VALUES (SEQ_MNO.NEXTVAL, '44444', '84849', '자기소개4', DEFAULT, DEFAULT, 'JAVA, AWS', 1, 'Y','마늘빵천사');
INSERT INTO MEMBER (MEM_NO, MEM_ID, MEM_TOKEN, MEM_INTRO, CREATE_DATE, STATUS, STACK_NAME, TEAM, TEAM_STATUS,GIT_NICK) VALUES (SEQ_MNO.NEXTVAL, '55555', '28922', '자기소개5', DEFAULT, DEFAULT, 'JAVA, AWS', 1, 'Y','붕어빵천사');
...
CREATE TABLE MEETING(
    ...
    MEETING_CREATER NUMBER REFERENCES MEMBER(MEM_NO) ON DELETE CASCADE NOT NULL,
...
CREATE TABLE MEETING_MEMBER(
    ...
    MEM_NO NUMBER REFERENCES MEMBER(MEM_NO) ON DELETE CASCADE NOT NULL
);

COMMENT ON COLUMN MEETING_MEMBER.MEETING_NO IS '회의번호';
COMMENT ON COLUMN MEETING_MEMBER.MEM_NO IS '회원번호';

--------------------------------------------------
--------------     FOLLOW	------------------	
--------------------------------------------------
CREATE TABLE FOLLOW(
    FOLLOWING_MEM NUMBER REFERENCES MEMBER(MEM_NO) ON DELETE CASCADE NOT NULL,
    FOLLOW_MEM NUMBER REFERENCES MEMBER(MEM_NO) ON DELETE CASCADE NOT NULL,
...
CREATE TABLE REPOSITORY(
    ...
    CREATE_DATE DATE DEFAULT SYSDATE,
    STATUS VARCHAR2(1) DEFAULT 'Y' CHECK (STATUS IN ('Y', 'N')),
    REF_MNO NUMBER REFERENCES MEMBER,
...
COMMENT ON COLUMN REPOSITORY.REF_MNO IS '참조 회원 번호';
COMMENT ON COLUMN REPOSITORY.REF_PNO IS '참조 프로젝트 번호';

-- 레파지토리 샘플 데이터 5개
INSERT INTO REPOSITORY (REPO_NO, REPO_TITLE, REPO_CONTENT, REPO_STATUS, CREATE_DATE, STATUS, REF_MNO, REF_PNO) VALUES (SEQ_RNO.NEXTVAL, 'FINAL_HTML', '레파지 내용임돠', DEFAULT, DEFAULT, DEFAULT, 1, 1);
INSERT INTO REPOSITORY (REPO_NO, REPO_TITLE, REPO_CONTENT, REPO_STATUS, CREATE_DATE, STATUS, REF_MNO, REF_PNO) VALUES (SEQ_RNO.NEXTVAL, 'FINAL_JSP', '레파지 내용임돠', DEFAULT, DEFAULT, DEFAULT, 1, 2);
INSERT INTO REPOSITORY (REPO_NO, REPO_TITLE, REPO_CONTENT, REPO_STATUS, CREATE_DATE, STATUS, REF_MNO, REF_PNO) VALUES (SEQ_RNO.NEXTVAL, 'FINAL_TEST', '레파지 내용임돠', DEFAULT, DEFAULT, DEFAULT, 1, 3);
INSERT INTO REPOSITORY (REPO_NO, REPO_TITLE, REPO_CONTENT, REPO_STATUS, CREATE_DATE, STATUS, REF_MNO, REF_PNO) VALUES (SEQ_RNO.NEXTVAL, 'FINAL_TEMPLATE', '레파지 내용임돠', DEFAULT, DEFAULT, DEFAULT, 1, 2);
INSERT INTO REPOSITORY (REPO_NO, REPO_TITLE, REPO_CONTENT, REPO_STATUS, CREATE_DATE, STATUS, REF_MNO, REF_PNO) VALUES (SEQ_RNO.NEXTVAL, 'FINAL_REAL', '레파지 내용임돠', DEFAULT, DEFAULT, DEFAULT, 1, 1);
...
CREATE TABLE PRO_COMMIT(
    ...
    COMMIT_MEM NUMBER CONSTRAINT COMMIT_MEM_FK REFERENCES MEMBER ON DELETE CASCADE,
...
-- 커밋 샘플 데이터 5개
INSERT INTO PRO_COMMIT (COMMIT_NO, COMMIT_MEM, COMMIT_DATE, COMM_HASH, REPO_NO) VALUES (SEQ_CNO.NEXTVAL, 1, DEFAULT, '로그인 기능 수정', 1);
INSERT INTO PRO_COMMIT (COMMIT_NO, COMMIT_MEM, COMMIT_DATE, COMM_HASH, REPO_NO) VALUES (SEQ_CNO.NEXTVAL, 1, DEFAULT, '좋아요 기능 버그 수정', 2);
INSERT INTO PRO_COMMIT (COMMIT_NO, COMMIT_MEM, COMMIT_DATE, COMM_HASH, REPO_NO) VALUES (SEQ_CNO.NEXTVAL, 1, DEFAULT, '레파지토리 등록 기능 추가', 3);
INSERT INTO PRO_COMMIT (COMMIT_NO, COMMIT_MEM, COMMIT_DATE, COMM_HASH, REPO_NO) VALUES (SEQ_CNO.NEXTVAL, 1, DEFAULT, '신고 기능 삭제', 4);
INSERT INTO PRO_COMMIT (COMMIT_NO, COMMIT_MEM, COMMIT_DATE, COMM_HASH, REPO_NO) VALUES (SEQ_CNO.NEXTVAL, 1, DEFAULT, '마이페이지 기능 코드 수정', 5);
...
-- 풀리퀘스트 리뷰 테이블 샘플데이터
INSERT INTO PULL_REVIEW (REVIEW_NO, REF_PULL, MEM_NO, REVIEW_CONTENT, CREATE_DATE) VALUES (SEQ_PRNO.NEXTVAL, 1, 1, '이상무', DEFAULT);
INSERT INTO PULL_REVIEW (REVIEW_NO, REF_PULL, MEM_NO, REVIEW_CONTENT, CREATE_DATE) VALUES (SEQ_PRNO.NEXTVAL, 2, 3, '유상무', DEFAULT);
INSERT INTO PULL_REVIEW (REVIEW_NO, REF_PULL, MEM_NO, REVIEW_CONTENT, CREATE_DATE) VALUES (SEQ_PRNO.NEXTVAL, 3, 2, '홍당무', DEFAULT);
